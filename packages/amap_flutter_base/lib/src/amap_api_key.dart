...
class AMapApiKey {
  ...
  ///
  ///[webKey] Web平台的key
  const AMapApiKey({this.iosKey, this.androidKey, this.webKey});
  ...
  bool operator ==(dynamic other) {
    ...
    return androidKey == typedOther.androidKey &&
        ...
        webKey == typedOther.webKey;
  }

  @override
  int get hashCode => Object.hash(androidKey, iosKey, webKey);

  @override
  String toString() {
    return 'AMapApiKey(androidKey: $androidKey, iosKey: $iosKey, webKey: $webKey)';
  }
}
